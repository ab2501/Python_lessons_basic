...
# 2. Решение без re (с помощью знакомых)
...
# 2. Решение без re (так же с помощью знакомых)
...
with open('Kirkudu.txt', 'w', encoding='UTF-8') as file:
    n = [str(random.randint(0, 9)) for _ in range(2499)]
    n = str(random.randint(1, 9)) + ''.join(n)
    file.write(n)

with open('Kirkudu.txt', 'r', encoding='UTF-8') as file:
    result = ['0']
